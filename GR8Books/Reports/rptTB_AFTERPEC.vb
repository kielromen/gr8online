...
Public Class rptTB_AFTERPEC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GR8Books.rptTB_AFTERPEC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTB_AFTERPEC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTB_AFTERPEC = New rptTB_AFTERPEC()
        rpt.Site = Me.Site
        Return rpt
    End Function
