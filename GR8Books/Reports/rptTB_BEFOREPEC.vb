...
Public Class rptTB_BEFOREPEC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GR8Books.rptTB_BEFOREPEC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTB_BEFOREPEC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTB_BEFOREPEC = New rptTB_BEFOREPEC()
        rpt.Site = Me.Site
        Return rpt
    End Function
