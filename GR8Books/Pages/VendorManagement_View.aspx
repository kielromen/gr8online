...
<%--     <div class="alert alert-success alert-dismissible fade show" role="alert" id="alertSave" runat="server">
    ...
    <asp:Panel runat="server">
         <div class="row mb-3 mr-2 justify-content-end">
                <div class="col">
                 <div class="input-group">
                      <asp:TextBox ID="txtFilter" runat="server" class="txtFilter form-control" autocomplete="off" placeholder="Vendor Name"  />
        ...
        <asp:GridView ID="gvVendor"  PageSize="13" runat="server" AutoGenerateColumns="false" AllowPaging="True" Width="100%" GridLines="None" ShowHeaderWhenEmpty="True" EmptyDataText="No Records Found">
