<%@ Page Title="Sales Invoice" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/Dashboard.Master" CodeBehind="SalesInvoice.aspx.vb" Inherits="GR8Books.SalesInvoice" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">  
        $(document).ready(function () {
            $('.txtGrossAmount').focusout(function () {
                $('.txtGrossAmount').formatCurrency();
                $('.txtGrossAmount').toNumber().formatCurrency('.txtGrossAmount');
            });
            $('.txtVATAmount').focusout(function () {
                $('.txtVATAmount').formatCurrency();
                $('.txtVATAmount').toNumber().formatCurrency('.txtVATAmount');
            });
            $('.txtDiscount').focusout(function () {
                $('.txtDiscount').formatCurrency();
                $('.txtDiscount').toNumber().formatCurrency('.txtDiscount');
            });
        });
    </script>
    ...
    <script type='text/javascript'>
        $(document).ready(function () {
            ...
            $(".txtAccntCode_Entry,.txtAccntTitle_Entry,.txtUOM_Entry,.txtQTY_Entry,.txtUnitPrice_Entry").keydown(function (e) {
                if (e.keyCode == 13) {
                    e.preventDefault;
                    return false;
                }
            ...
            $(".txtAccntTitle_Entry").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: "<%= ResolveUrl("SalesInvoice.aspx/ItemList")%>",
            ...
            $(".btnSearch").click(function () {
                window.location = "SalesInvoice_Loadlist.aspx";
                return false;
            });
                ...
                <div class="col">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col">
                            ...
                            <asp:RequiredFieldValidator Display="Dynamic" ID="RequiredFieldValidator3" runat="Server" ControlToValidate="txtVATAmount" ErrorMessage="Field is required." ValidationGroup="g"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-3 my-auto">
                        ...
                        <div class="col">
                            <asp:TextBox ID="txtDiscount" runat="server" class="txtDiscount form-control text-right" autocomplete="off" />
                            <asp:RequiredFieldValidator Display="Dynamic" ID="RequiredFieldValidator5" runat="Server" ControlToValidate="txtDiscount" ErrorMessage="Field is required." ValidationGroup="g"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-3 my-auto">
