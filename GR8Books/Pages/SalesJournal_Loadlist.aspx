<%@ Page Title="Sales Journal Transaction List" EnableEventValidation="false" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/Dashboard.Master" CodeBehind="SalesJournal_Loadlist.aspx.vb" Inherits="GR8Books.SalesJournal_Loadlist" %>
    ...
    <asp:Panel runat="server">
        ...
        <asp:GridView ID="dgvList" runat="server" AutoGenerateColumns="false" Width="80%" GridLines="none" OnSelectedIndexChanged="OnSelectedIndexChanged" OnRowDataBound="GridView_RowDataBound">
            <Columns>
                ...
                <asp:BoundField DataField="SJ_No" HeaderText="Trans No" />
