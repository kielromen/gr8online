<%@ Page Title="Book of Accounts" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/Dashboard.Master" CodeBehind="Reports_BookofAccounts.aspx.vb" Inherits="GR8Books.Reports_BookofAccounts" %>
    ...
    <div class="row row-cols-2">
        <div class="col-6">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col">
                        <asp:TextBox ID="dtpToDate" TextMode="Date" Autopostback="true" class="dtpFromDate form-control" runat="server"/>
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col-6">
