...
Public Class OfficialReceipt
    ...
    Private Sub LoadTransaction(ByVal ID As String)
        ...
        query = " SELECT  TransID, OR_No, tblCollection_OR.VCECode, Name, TransDate, Amount, Remarks, PaymentType, " &
    ...
    Public Sub Save()
        ...
        insertSQL = " INSERT INTO " &
                        " tblCollection_OR (TransID,  OR_No, TransDate, VCECode, PaymentType, Amount,  CheckRef, BankRef, CheckDate, Remarks, TransAuto, WhoCreated) " &
                        " VALUES(@TransID, @OR_No, @TransDate, @VCECode, @PaymentType, @Amount, @CheckRef, @BankRef, @CheckDate, @Remarks, @TransAuto, @WhoCreated)"
        SQL.FlushParams()
    ...
    Private Sub Update()
        ...
        updateSQL = " UPDATE tblCollection_OR  " &
                        " SET     OR_No = @OR_No, TransDate = @TransDate, PaymentType = @PaymentType, " &
