Public Class SalesInvoice_Loadlist
    ...
    Public Sub LoadList()
        Dim query As String
        query = " SELECT   TransID, TransNo , REPLACE(CAST(DateTrans as DATE),' 12:00:00 AM','') as TransDate, tblSI.VCECode as VCECode, GrossAmount, Remarks, tblSI.Status as Status " &
    ...
    Protected Sub OnSelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs)
        ...
        txtFilter.Text = ""
        Session("ID") = TransID
        Response.Write("<script>window.location='SalesInvoice.aspx';</script>")
    End Sub
