<%@ Page Title="Provisional Receipt" MaintainScrollPositionOnPostback="true" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/Dashboard.Master" CodeBehind="ProvisionalReceipt.aspx.vb" Inherits="GR8Books.ProvisionalReceipt" %>
        ...
        <asp:Panel ID="panelConrols" runat="server">
            <div class="row mt mb-5">
                ...
                <div class="col">
                    <div class="row mb-2">
                        <div class="col-4 my-auto">
                            <asp:Label Text="PR No.:" runat="server" />
                        </div>
                        <div class="col">
