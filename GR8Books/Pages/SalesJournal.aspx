<%@ Page Title="Sales Journal" EnableEventValidation="false" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/Dashboard.Master" CodeBehind="SalesJournal.aspx.vb" Inherits="GR8Books.SalesJournal" %>
                ...
                <div class="col-sm-8">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-9">
                            ...
                            <asp:RequiredFieldValidator Display="Dynamic" ID="RequiredFieldValidator2" runat="Server" ControlToValidate="txtAmount" ErrorMessage="Field is required." ValidationGroup="g"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-2 my-auto">
