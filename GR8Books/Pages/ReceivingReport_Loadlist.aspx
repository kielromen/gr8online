<%@ Page Title="Receiving Report Transaction List" EnableEventValidation = "false" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/Dashboard.Master" CodeBehind="ReceivingReport_Loadlist.aspx.vb" Inherits="GR8Books.ReceivingReport_Loadlist" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel runat="server">   
          ...
          <Columns>
                ...
                <asp:BoundField DataField="RR_NO" HeaderText="Trans No" />
                <asp:BoundField DataField="VCEName" HeaderText="VCE Code" />
                <asp:BoundField DataField="TransDate" HeaderText="Trans Date" />
                <asp:BoundField DataField="DateDeliver" HeaderText="Delivery Date" />
