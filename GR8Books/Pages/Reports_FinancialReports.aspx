<%@ Page Title="Financial Reports" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/Dashboard.Master" CodeBehind="Reports_FinancialReports.aspx.vb" Inherits="GR8Books.Reports_FinancialReports" %>
    ...
    <div class="row row-cols-2">
        <div class="col-6">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col">
                        <asp:TextBox ID="dtpFromDate" TextMode="Date" class="dtpFromDate form-control" runat="server" />
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col-3 my-auto">
            ...
            <div class="col-5">
                ...
                <div class="row mb-2">
                    <div class="input-group">
                                <asp:TextBox ID="txtSearch" runat="server" class="form-control" placeholder="Search" AutoPostBack =" true" OnTextChanged="LoadAccounts" autocomplete="off" />
                                <div class="input-group-append">
                                    <asp:Button Text="Search" ID="btnSearch" runat="server" class="btn btn-primary" OnClick="LoadAccounts"/>
                                </div>
                            </div>                       
                </div>
                <div class="row mb-2">
