<%@ Page Title="Purchase Order Transaction List" EnableEventValidation = "false" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/Dashboard.Master" CodeBehind="PurchaseOrder_Loadlist.aspx.vb" Inherits="GR8Books.PurchaseOrder_Loadlist" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel runat="server">   
          ...
          <Columns>
                ...
                <asp:BoundField DataField="PO_NO" HeaderText="Trans No" />
                <asp:BoundField DataField="VCECode" HeaderText="VCE Code" />
                <asp:BoundField DataField="DatePO" HeaderText="Trans Date" />
