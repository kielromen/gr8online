<%@ Page Title="Acknowledgement Receipt" MaintainScrollPositionOnPostback="true" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/Dashboard.Master" CodeBehind="AcknowledgementReceipt.aspx.vb" Inherits="GR8Books.AcknowledgementReceipt" %>
        ...
        $(document).ready(function () {
            ...
            $(".txtAccntTitle_Entry").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: "<%= ResolveUrl("AcknowledgementReceipt.aspx/ListAccountTitle") %>",
            ...
            $(".txtName_Entry").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: "<%= ResolveUrl("AcknowledgementReceipt.aspx/ListVCE") %>",
                        data: "{'prefix': '" + request.term + "'}",
                        dataType: "json",
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
        ...
        <asp:Panel ID="panelConrols" runat="server">
            <div class="row mt mb-5">
                ...
                <div class="col">
                    <div class="row mb-2">
                        <div class="col-4 my-auto">
                            <asp:Label Text="AR No.:" runat="server" />
                        </div>
                        <div class="col">
