<%@ Page Title="Delivery Receipt Transaction List" EnableEventValidation = "false" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/Dashboard.Master" CodeBehind="DeliveryReceipt_Loadlist.aspx.vb" Inherits="GR8Books.DeliveryReceipt_Loadlist" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel runat="server">   
          ...
          <Columns>
                ...
                <asp:BoundField DataField="DateTrans" HeaderText="Trans Date" />
