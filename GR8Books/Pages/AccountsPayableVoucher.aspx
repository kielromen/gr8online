        ...
        $(document).ready(function () {
            ...
            $(".txtAccntTitle_Entry").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: "<%= ResolveUrl("AccountsPayableVoucher.aspx/ListAccountTitle") %>",
            ...
            $(".txtName_Entry").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: "<%= ResolveUrl("AccountsPayableVoucher.aspx/ListVCE") %>",
                        data: "{'prefix': '" + request.term + "'}",
                        dataType: "json",
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
        ...
        <asp:Panel ID="panelConrols" runat="server">
            ...
            <div class="row mb-2">
                <div class="col-5">
                    ...
                    <div class="row mb-2">
                        <div class="col-3 my-auto text-nowrap">
                            <asp:Label Text="Credit Account:" runat="server" />
                        </div>
                        <div class="col">
                    ...
                    <div class="row mb-2">
                        <div class="col-3 my-auto text-nowrap">
                            <asp:Label Text="Payable Type:" runat="server" />
                        </div>
                        <div class="col">
                ...
                <div class="col">
                    ...
                    <div class="row mb-2">
                        <div class="col-4 my-auto">
                           <asp:Label Text="Discount:" runat="server" class="col-sm-3 col-form-label"  />
                        </div>
                        <div class="col">
                    ...
                    <div class="row mb-2">
                         <div class="col-4 my-auto text-nowrap">
                           <asp:Label Text="Input VAT:" runat="server" class="col-sm-3 col-form-label"  />
                        </div>
                        <div class="col">
                    ...
                    <div class="row mb-2">
                         <div class="col-4 my-auto">
                           <asp:Label Text="WTax:" runat="server" class="col-sm-3 col-form-label"  />
                        </div>
                        <div class="col">
                            <asp:TextBox ID="txtWTax" runat="server" class="form-control text-right" type="number" autocomplete="off" />  
                        </div>
                    </div>
                    <div class="row mb-2">
                         <div class="col-4 my-auto text-nowrap">
                            <asp:Label Text="Net Amount:" runat="server" class="col-sm-3 col-form-label"  />
                        </div>
                        <div class="col">
                ...
                <div class="col">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col">
                            <input type="date" runat="server" id="dtpDoc_Date" class="form-control " autocomplete="off" />
                        </div>
                    </div>
                    <%--<div class="row mb-2">
                         <div class="col-4 my-auto">
                        ...
                        <div class="col">
                            <asp:TextBox ID="txtRef_Type" runat="server" class="form-control " autocomplete="off" />
                        </div>
                    </div>
                    <div class="row mb-2">
                         <div class="col-4 my-auto">
