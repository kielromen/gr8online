...
Public Class DisbursementType_Maintenance
    ...
    Public Sub EnableControl(ByVal Value As Boolean)
        panelDisbursementType.Enabled = Not Value
    End Sub
    ...
    Public Sub Initialize()
        ...
        ddlModule.Items.Add("Cash Voucher")
        ddlModule.Items.Add("Check Voucher")
        ddlModule.Items.Add("Accounts Payable Voucher")
        ddlModule.Items.Add("Petty Cash Fund Module")
    End Sub

    Private Sub DisbursementType_Maintenance_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
    ...
    Public Sub View()
        ...
        query = " SELECT * FROM tblDisbursement_Type " &
                ...
                " WHERE tblDisbursement_Type.Status = @Status AND ID = @ID"
        SQL.FlushParams()
        SQL.AddParam("@ID", ID)
    ...
    Public Sub Save()
        Dim query As String
        query = " INSERT INTO tblDisbursement_Type " &
    ...
    Public Sub Update()
        Dim ID As String = Request.QueryString("ID")
        Dim query As String
        query = " UPDATE tblDisbursement_Type " &
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If (Page.IsValid) Then
            If btnSave.Text = "Save" Then
                Save()
                Response.Write("<script>alert('Successfully Saved.');window.location='DisbursementType_Loadlist.aspx';</script>")
    ...
    Private Sub btnCancel_Click(sender As Object, e As EventArgs) Handles btnCancel.Click
        ...
        If Actions = "Edit" Then
            Response.Write("<script>window.close();</script>")
        Else
            Response.Write("<script>window.location='DisbursementType_LoadList.aspx';</script>")
        End If
    End Sub
End Class