<%@ Page Title="Journal Voucher" MaintainScrollPositionOnPostback="true" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/Dashboard.Master" CodeBehind="JournalVoucher.aspx.vb" Inherits="GR8Books.JournalVoucher" %>
        ...
        $(document).ready(function () {
            ...
            $(".txtAccntTitle_Entry").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: "<%= ResolveUrl("JournalVoucher.aspx/ListAccountTitle") %>",
            ...
            $(".txtName_Entry").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: "<%= ResolveUrl("JournalVoucher.aspx/ListVCE") %>",
                        data: "{'prefix': '" + request.term + "'}",
                        dataType: "json",
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
            ...
            <div class="row mb-2">
                <div class="col-sm-8">
                    <div class="row mb-2">
                        ...
                        <div class="col">
                            <asp:TextBox ID="txtRemarks" runat="server" class="form-control " autocomplete="off" TextMode="MultiLine" Height="80px" />
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="row mb-2">
                        ...
                        <div class="col">
                            ...
                            <asp:RequiredFieldValidator Display="Dynamic" ID="RequiredFieldValidator4" runat="Server" ControlToValidate="txtTrans_Num" ErrorMessage="Field is required." ValidationGroup="g"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-sm-5 my-auto text-nowrap">
